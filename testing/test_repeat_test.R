...
data_columns = c("ALEXP.Values", "BENTOT.Values")
...
rounding_patterns_to_omit=c('000', '5')#c('0','00','000','0000', '00000', '000000', '5', '50', '500')

result = repeat_test(DigitData, data_columns=data_columns, duplicate_matching_cols=duplicate_matching_cols,
                     break_out=break_out, break_out_grouping=break_out_grouping, rounding_patterns_to_omit=rounding_patterns_to_omit)
result
