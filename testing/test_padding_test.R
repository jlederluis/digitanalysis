...
# max_length = 7
# num_digits = 5
# N = 10#1#100000 #120k datasets took 15 mins #2400s for N=10,000; data dimension = 4000 x 5 total digits
# omit_05 = c(0,5)
# break_out = 'DIST'
...
#                       break_out_grouping=break_out_grouping, category=category, category_grouping=category_grouping,
#                       simulate=simulate, plot=TRUE)
# #result
# proc.time() - ptm
#
