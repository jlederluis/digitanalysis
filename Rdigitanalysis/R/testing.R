...
#
# #test repeat test
# duplicate_matching_cols = c('ALEXP', 'DIST')
# break_out = 'DIST'
#
# repeat_test(DigitData, duplicate_matching_cols, break_out=break_out)
#
# #sector
# break_out ='DIST'
...
# sector_test(DigitData, sector_column, sector_grouping, duplicate_matching_cols, break_out, failure_factor=3)
#
#
# #test high low test
# data_columns = 'all'
...
# break_out = 'YEAR'
#
# a=high_low_test(DigitData, contingency_table, data_columns, high, omit_05, skip_first_digit, skip_last_digit, break_out)
#
#
#
# #test padding test
