...
# remove_by_index = function(array, index){
#   return(array[as.integer(paste('-',as.character(index),sep = ""))])
#
# }
# scientific_to_numeric = function(scientific_number){
#   chars = tolower(strsplit(as.character(scientific_number), ""))
#   print(chars)
#   if (!is.na(match('e',chars))){
#     index_e = match('e',chars)
#     index_plus = match('+',chars)
#     chars = remove_by_index(chars, index_e)
#     chars = remove_by_index(chars, index_plus)
#
#     exponent = ''
#     while (!is.na(chars[index_e])){
#       exponent = paste(exponent,chars[index_e],"")
#       chars = remove_by_index(chars, index_e)
#     }
#
#     chars = append(chars, rep(0, as.integer(exponent)))
#   }
#   return(chars)
# }
